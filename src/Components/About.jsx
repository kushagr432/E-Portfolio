...
<div className='md:order-1 bg-gray-200 relative z-0 h-fit w-full'>
...
<div className='flex flex-row md:order-1 sm:flex-col w-full flex-wrap sm:w-auto sm:flex-nowrap'>
    ...
    {/* <div className='w-12 order-2 sm:w-0'></div> */}
<div className='md:order-3 pt-10'>
